...
<p align="center">
    ...
    <a href="https://github.com/ui-awesome/html-attribute/actions/workflows/security.yml" target="_blank">
        <img src="https://img.shields.io/github/actions/workflow/status/ui-awesome/html-attribute/security.yml?style=for-the-badge&label=Security&logo=github" alt="Security">
    </a>
</p>
...
```bash
composer require ui-awesome/html-attribute:^0.7
```
...
[![Quality](https://img.shields.io/github/actions/workflow/status/ui-awesome/html-attribute/quality.yml?style=for-the-badge&label=Quality&logo=github)](https://github.com/ui-awesome/html-attribute/actions/workflows/quality.yml)
