...
/**
 * Represents global `on*` event handler attribute names.
 *
 * @see https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Global_attributes#list_of_global_event_handler_attributes
 */
enum Event: string
{
    /**
