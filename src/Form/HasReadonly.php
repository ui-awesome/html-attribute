...
trait HasReadonly
{
     ...
     * the input.
     * - Unlike `disabled`, a readonly input is still focusable, can be tabbed to, and its value is submitted with the
     *   form.
     * - It is not applicable to `<button>`, `<input type="checkbox">`, `<input type="color">`, `<input type="hidden">`,
