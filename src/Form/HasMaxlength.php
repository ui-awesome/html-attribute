 ...
 * - Supports `int`, `string`, `Stringable`, `UnitEnum`, and `null` for flexible maxlength assignment.
 *
...
trait HasMaxlength
{
     ...
     * enter into the field. This must be an integer value of 0 or higher.
     * - If no `maxlength` is specified, or an invalid value is specified, the field has no maximum length.
     * - It is valid for text, search, url, tel, email, and password input types, as well as textarea.
     * - The input will fail constraint validation if the length of the text entered exceeds `maxlength` UTF-16 code
     *   units.
     ...
     *
     * @param int|string|Stringable|UnitEnum|null $value Maximum length (number of characters) to set for the element.
